package com.hqy.commonlibrary.utils.okhttp;

import android.util.Log;

import com.hqy.commonlibrary.utils.AndroidLogWrapperUtil;
import com.hqy.commonlibrary.utils.exector.AppExecutors;
...
//                https.setSSLSocketFactory(sf);
                ...
                AndroidLogWrapperUtil.d(TAG," httpGet  success ");
            } catch (IOException e) {
                e.printStackTrace();
            } catch (NoSuchAlgorithmException e) {
                e.printStackTrace();
